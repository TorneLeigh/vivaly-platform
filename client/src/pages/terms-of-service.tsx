...
export default function TermsOfService() {
  useEffect(() => {
    document.title = "Terms of Service | CareConnect Australia";
  }, []);
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="prose prose-lg max-w-none">
        ...
        <p>
          By accessing and using CareConnect Australia ("we," "our," or "the Platform"), you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use our platform.
        </p>

        <h2>2. Description of Service</h2>
        <p>
          CareConnect Australia is a digital marketplace that connects families with verified caregivers across childcare, eldercare, and pet care services. We facilitate connections but do not directly provide care services.
        </p>
