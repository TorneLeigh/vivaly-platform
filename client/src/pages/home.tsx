          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="relative w-full h-[500px] bg-gradient-to-br from-blue-50 to-pink-50 rounded-3xl overflow-hidden shadow-2xl">
                ...
                <div className="absolute top-1/5 right-2/6 animate-bounce" style={{animationDelay: '0.3s'}}>
                  <div className="text-center">
                ...
                <div className="absolute bottom-1/5 right-1/4 animate-bounce" style={{animationDelay: '1.3s'}}>
                  <div className="text-center">
                ...
                <svg className="absolute inset-0 w-full h-full" viewBox="0 0 400 400">
                  ...
                  <line x1="200" y1="200" x2="265" y2="80" stroke="#FFC107" strokeWidth="2" strokeDasharray="6,6" opacity="0.7">
                  ...
                  <line x1="200" y1="200" x2="300" y2="320" stroke="#9C27B0" strokeWidth="2" strokeDasharray="6,6" opacity="0.7">
