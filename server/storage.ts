  ...
  private seedChildcareProviders() {
    ...
    providerUsers.forEach(userData => {
      ...
      const providers = [
        ...
        {
          centerName: "Bright Beginnings Family Day Care",
          description: "Home-based family day care with qualified early childhood educator. Provides educational activities and school readiness programs in compliance with Australian family day care regulations.",
          ...
          totalCapacity: 7,
          babyCapacity: 4,
          ageGroups: ["0-2 years", "2-3 years", "3-5 years", "school age"],
          operatingDays: ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday"],
          startTime: "8:00 AM",
          endTime: "2:00 PM",
          hourlyRate: "13.00",
        ...
        {
          centerName: "Little Learners Family Day Care",
          description: "Home-based Montessori family day care with qualified educator. Provides authentic Montessori activities while maintaining compliance with Australian family day care regulations (max 7 children, max 4 under school age).",
        ...
        {
          centerName: "Sunshine Family Day Care",
          description: "Home-based family day care providing warm, nurturing care in a safe family environment. Maximum 4 children under school age with dedicated play areas and educational activities.",
          ...
          totalCapacity: 7,
          babyCapacity: 4,
          ageGroups: ["0-2 years", "3-5 years", "school age"],
          operatingDays: ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday"],
          startTime: "7:00 AM",
          endTime: "6:00 PM",
          hourlyRate: "12.50",
