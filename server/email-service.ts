    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff;">
        ...
        <div style="padding: 30px 20px;">
          ...
          <div style="text-align: center; margin: 30px 0;">
            <a href="https://www.vivaly.com.au" style="background: #000000; color: white; padding: 12px 25px; text-decoration: none; border-radius: 8px; font-weight: bold; display: inline-block; margin: 0 10px 10px 0;">FIND CARE</a>
